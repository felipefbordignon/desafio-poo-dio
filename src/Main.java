...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Pedro:" + devJoao.getConteudosInscritos());
        devJoao.progredir();
        devJoao.progredir();
        devJoao.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Pedro:" + devJoao.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Pedro:" + devJoao.getConteudosConcluidos());
